...
\end{equation}
We will use this likelihood function to compute the extinction rate $\lambda$ for the selected species.
...
## Plot Distribution of the inferred extinction time
hist(1/as.matrix(jags.res),main="MTE",ylab="time (weeks)")
